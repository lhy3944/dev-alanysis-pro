...
interface ResponsiveLeftPanelHostProps {
   ...
   * - `state === "expanded"` 이면 260px 펼침 강제 렌더 (태블릿 overlay / 모바일 sheet).
   */
 ...
 * - Desktop (≥1024px): 260 ↔ 60 push (기존 동작)
      ...
      <>
        ...
        {leftSidebarOpen && (
          <>
            ...
            <div
              className={cn(
                "absolute inset-y-0 left-0 z-30 w-[260px] overflow-hidden border-r border-line-primary bg-canvas-surface shadow-lg",
                className,
              )}
            >
              {render("expanded")}
